    ...
    <div class="container">
        <div class="masthead-pad">
            <div class="masthead-text">
                <h2>Data Artikel</h2>
                <p>Halaman Management Data Artikel (Berita, Pengumuman, Agenda)</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="span12">    
                <div class="alert alert-info">
                    Data artikel UPTD Pasar Tradisional Semi Modern Cisaat
                </div>
                <a href="?page=<?php echo base64_encode('artikel_input'); ?>"><button class="btn btn-info btn-sm">MASUKAN DATA BARU</button></a>
                <br>
                <br>
                <div id="tablewrapper">
                    <div id="tableheader">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="table" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                $no = 1;
                                $query = mysql_query("SELECT * FROM informasi ORDER BY id DESC") or die (mysql_error('Tabel tidak ditemukan'));
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="+home.php?page=<?php echo base64_encode('artikel_detail') ?><?php echo '&id='.$id; ?>"><div class="btn btn-info btn-sm">DETAIL</div></a>
                                    <a href="+home.php?page=<?php echo base64_encode('artikel_input_update') ?><?php echo '&id='.$id; ?>"><div class="btn btn-warning btn-sm">UPDATE</div></a>
                                    <a href="+home.php?page=<?php echo base64_encode('artikel_delete') ?><?php echo '&id='.$id; ?>"><div class="btn btn-danger btn-sm">DELETE</div></a>
                                </td>
                            </tr>
                            <?php
                                $no++;
