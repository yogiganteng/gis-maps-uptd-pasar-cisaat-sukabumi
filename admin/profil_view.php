        ...
        <div class="row">
            <div class="span12">    
                <div class="alert alert-info">
                	Data Profil UPTD Pasar Tradisional Semi Modern Cisaat
                </div>
                <a href="?page=<?php echo base64_encode('profil_input'); ?>"><button class="btn btn-info btn-sm">MASUKAN DATA BARU</button></a>
                <br>
                <br>
                <div id="tablewrapper">
					<div id="tableheader">
			        ...
			        <table cellpadding="0" cellspacing="0" border="0" id="table" class="table table-bordered table-striped">
			            ...
			            <tbody>
			            	<?php
			            		...
			            		$no = 1;
			            		$query = mysqli_query($koneksi,"SELECT * FROM profil") or die (mysqli_error('Tabel tidak ditemukan'));
			                ...
			                <tr>
				            	...
				            	<td>
				            		<a href="+home.php?page=<?php echo base64_encode('profil_input_update') ?><?php echo '&id='.$id; ?>"><button class="btn btn-warning btn-sm">UPDATE</button></a>
				            		<a href="+home.php?page=<?php echo base64_encode('profil_delete') ?><?php echo '&id='.$id; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a>
				            	</td>
			                </tr>
			                <?php
			                	$no++;
