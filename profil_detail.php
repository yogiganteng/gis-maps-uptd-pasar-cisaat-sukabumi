                ...
                <div class="container-fluid">
                    <div class="row">
                        <?php
                            ...
                            $query = mysqli_query("SELECT * FROM profil WHERE id='$id'") or die (mysqli_error('Tabel tidak ditemukan'));
                                ...
                                <div class="row">
                                    ...
                                    <div class="span9">    
                                        ...
                                        <!-- <div class="post-comments pad-25">
                                          ...
                                          <?php
                                             $query = "SELECT * FROM komentar WHERE id_topik='$id' AND topik='Profil' ORDER BY id DESC";
                                              ...
                                              <li class="media">
                                                  ...
                                                  <div class="media-body">
                                                      <h5 class="media-heading">
                                                          <a href="informasi_read.php?&id=<?php echo $id; ?>"><?php echo $data['nama']; ?></a>
                                        ...
                                        <br>
                                        <hr>
                                        <form action="profil_komentar.php" method="POST">
